...
const adminEmail = "khaibq1.vss@gmail.com"; // chỉnh sửa lại đúng với thực tế
const adminPassword = "yartvbgjlbawgeuxy"; // chỉnh sửa lại đúng với thực tế
// Mình sử dụng host của google - gmail
const mailHost = 'smtp.gmail.com'
// 587 là một cổng tiêu chuẩn và phổ biến trong giao thức SMTP
const mailPort = 587

export const sendMail = (to: any, subject: any, htmlContent: any) => {
