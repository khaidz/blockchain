...
export default function Prescription ({mbId}) {
    ...
    const getUser = async () => {  
        ...
        const url = 'http://192.168.1.10:3000/patient/search-prescription?field=prescription_medical_bill_id&value='+mbId;
...
// style={{ flex: 1,justifyContent: 'flex-start', alignItems: 'center'}}
    return (
         <View > 
            ...
            :   <View><Text>Không tìm thấy đơn thuốc!</Text></View>
            }
        </View>
