...
export default () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => {
                if (!record.user_is_deleted) return <Tag color="success">Hoạt động</Tag>;
                ...
                if (!record.user_is_deleted)
                    return (
                        <>
                            ...
                            <Button type="link" onClick={() => handleEditIsDeleted(record.user_id)}>
                                Khóa
                            </Button>
                        </>
                    );
                return (
                    <Button type="link" onClick={() => handleEditIsActived(record.user_id)}>
                        Kích hoạt ngay
                    </Button>
                );
            },
            ...
            <Card>
                ...
                >
                    <Form.Item name="field" style={{ width: 200, float: 'left' }}>
                        <Select placeholder="Tìm kiếm bằng">
                            ...
                            <>
                                {a ? (
                                    <>
                                        {' '}
                                        <Alert
                                            style={{ width: 200, float: 'none', margin: 10 }}
                                            showIcon
