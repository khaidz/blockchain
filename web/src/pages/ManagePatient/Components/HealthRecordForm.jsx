    ...
    return (
        <Card>
            ...
            >
                    ...
                    rules={[
                        {
                            validator: async (rule, value) => {
                                if (await validate('health_record_patient_id', value))
                                    throw new Error('Sổ khám đã tồn tại');
                            },
                        },
                    ]}
                >
                ...
                <Form.Item hasFeedback label="Họ và tên" name="user_fullname">
                    <Input readOnly disabled={true}></Input>
                </Form.Item>
                ...
                <Form.Item label="Số CMND/CCCD" hasFeedback>
                ...
                <Form.Item
                    ...
                    rules={[
                        ...
                        {
                            validator: async (rule, value) => {
                                if (await validate('health_record_health_insurance', value))
                                    throw new Error('Sổ khám đã tồn tại');
                            },
                        },
                    ]}
