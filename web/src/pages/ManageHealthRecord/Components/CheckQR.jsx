    ...
    },
    {
        ...
        render: (text, record) => {
            if (!record.medical_bill_is_completed)
                ...
                return <Button type='link' onClick={() => handleViewClick(record)}>Xem phiếu khám</Button>
        }
    }
]
    return(
      <>
        <Card>
          {!qr?  <Button onClick={handleSetQR}>Quét lại</Button> :<QrReader
            delay={10}
            style={previewStyle}
            onScan={handleScan}
            disabled={posting}
                        ...
                        <Card>
                          ...
                          {checkQR ? 
                            ...
                            >
                              ...
                              /> 
                              <Alert showIcon message="Vui lòng cung cấp mã QR của bệnh nhân!"></Alert>
                            </Modal>
                          }
