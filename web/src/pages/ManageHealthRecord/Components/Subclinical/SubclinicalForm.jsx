...
export default ({mbId}) => {
    ...
    return (
        ...
        >
            ...
            hasFeedback
            rules={[
                { required: true, message: 'Vui lòng chọn dịch vụ cận lâm sàng' }
                
            ]}>
                <Select disabled={loading}>
                    { sData.map((element) => {
                       return (
                                <Option key={element.subclinical_id} 
                                value={element.subclinical_name}
                                >
                                {element.subclinical_name}</Option>
                        )
                    })
                    }
                </Select>
