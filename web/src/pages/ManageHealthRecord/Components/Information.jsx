        ...
        <Card>
            ...
            >
                <Card>
                    ...
                    <Form.Item hasFeedback name="medical_bill_patient_id" label="ID bệnh nhân">
                    ...
                    <Form.Item hasFeedback label="Khoa" name="medical_bill_department_name">
                        <Input readOnly></Input>
                    </Form.Item>
                    <Form.Item hasFeedback label="Phòng" name="medical_bill_room_name">
                        <Input readOnly></Input>
                    </Form.Item>
                    <Form.Item label="Bác sĩ" hasFeedback name="medical_bill_physician_name">
                        <Input readOnly></Input>
                    </Form.Item>
                </Card>
                <Card>
                    ...
                    <Divider></Divider>
                    <Form.Item label="Nhiệt độ" hasFeedback name="vital_signs_temperature">
                        <Input readOnly></Input>
                    </Form.Item>
                    <Form.Item label="Huyết áp" hasFeedback name="vital_signs_blood_pressure">
                        <Input readOnly></Input>
                    </Form.Item>
                    <Form.Item label="Nhịp thở" hasFeedback name="vital_signs_breathing">
                        <Input readOnly></Input>
                    </Form.Item>
                    <Form.Item label="Nhịp tim" hasFeedback name="vital_signs_pluse">
                        <Input readOnly></Input>
                    </Form.Item>
                </Card>
                <Card>
                    ...
                    <Form.Item label="Tiền sử bệnh" hasFeedback name="medical_bill_anamnesis">
                        <Input readOnly></Input>
                    </Form.Item>
                    <Form.Item label="Lịch sử bệnh" hasFeedback name="medical_bill_medical_history">
                        <Input readOnly></Input>
                    </Form.Item>
                    {/* <Form.Item
                ...
                >
                    ...
                    <Form.Item label="Chẩn đoán bệnh" hasFeedback name="medical_bill_diagnose">
                        <Input readOnly></Input>
                    </Form.Item>
                ...
                >
                    ...
                    <Form.Item label="Hẹn tái khám" hasFeedback name="medical_bill_appointment">
                ...
                <Form.Item name="medical_bill_is_completed" label="Trạng thái:">
                    {comp ? <Button>Đã hoàn thành</Button> : <Button>Chưa hoàn thành</Button>}
                </Form.Item>
            </Form>
        </Card>
    );
