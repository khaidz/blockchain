                ...
                rules={[
                    { required: true, message: 'Vui lòng nhập tên phòng' },
                    {
                        validator: async (rule, value) => {
                            if (!(await validate('room_name', value))) throw  new Error('Tên phòng đã tồn tại');
                        },
                    },
                ]}>
            ...
            rules={[
                ...
                <Select disabled={loading}>
                    { departmentData.map((element) => {
                       return (<Option key={element.department_id} value={element.department_name}>{ element.department_name }</Option>)
                    })
                    }
                </Select>
            </Form.Item>
